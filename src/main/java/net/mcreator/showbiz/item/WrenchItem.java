...
import net.mcreator.showbiz.procedures.WrenchRightclickedOnBlockProcedure;
...
public class WrenchItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.showbiz.wrench.description_0"));
		list.add(Component.translatable("item.showbiz.wrench.description_1"));
	}
